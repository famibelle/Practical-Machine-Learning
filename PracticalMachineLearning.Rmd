...
The  "X", "user_name", "raw_timestamp_part_1", "raw_timestamp_part_2", "cvtd_timestamp", [6] "new_window", "num_window" are not part of the predictors and then can be removed from the model
...
`r confusionMatrix.PML$overall[1]`
